...
TARGET_PRODUCTS = [
    ...
    {"name": "サンリオキャラクターズ けろけろパーティー めじるしアクセサリー", "code": "4570118186782"},
    {"name": "サンリオキャラクターズ～なりきりメンダコ～ ", "code": "4582769746017"},
    {"name": "サンリオキャラクターズ カラともマスコット", "code": "4570118205568"},
    {"name": "サンリオキャラクターズ キーリングハンガー", "code": "4582769978890"}
]
